				...
				$("#loginSubmitBut").click(function(){
					...
					$.post("${pageContext.request.contextPath}/login/loginUser.action",data,function(message){
						...
						if(message.messageCode==1){
							window.location.href="${pageContext.request.contextPath}/main/toMain.action";
						}else{
					...
					<form action="index.html" method="post">
						<div class="panel loginbox" style="margin-top: -100px;">
							...
							<div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
								...
								<div class="form-group">
									<div class="field field-icon-right">
										<input type="password" class="input input-big" name="password" id="loginPwd" placeholder="登录密码" value="${cookie.loginPwd.value}" data-validate="required:请填写密码" />
							...
							<div style="padding:30px;"><input type="button" class="button button-block bg-main text-big input-big" id="loginSubmitBut" value="登录"></div>
						</div>
					</form>
				</div>
			</div>

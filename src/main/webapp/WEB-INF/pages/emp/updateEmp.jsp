...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="${pageContext.request.contextPath}/emp/update.action" enctype="multipart/form-data">
	  ...
	  <div class="form-group">
		...
		<div class="field">
			<img src="${pageContext.request.contextPath}/fileupload/${emp.empPhoto}" width="50px ">
	  ...
	  <div class="form-group">
	    <div class="label">
		  ...
		  <div class="field">
			  <input  type="text" class="input w50" value="${emp.deptNo	}" name="deptNo"/>
			</div>
	  </div>
	  
	  <div class="form-group">
	    <div class="label">
			<label><font color="red">${updateError}</font></label>
	    </div>
	    <div class="field">
